...
const goals = () => {
  ...
  const options = ['Lose Weight', 'Maintain Weight', 'Gain Weight', 'Gain Muscle', 'Plan Meals', 'Manage Stress', 'Stay Active'];
